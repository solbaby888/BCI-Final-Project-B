    % Checkpoint 1
function [f, Correlation, TRAIN] = Training_Code(ECoG_Sub_Chan, fs_ECOG, no_of_channels_ECOG, Glovedata);
%{ 
...
for i = 1:no_of_channels_ECOG;
    ECoG_Sub_Chan_filt{i} = hampel(filtfilt(d, ECoG_Sub_Chan{i}));  
end;
...
%     spline
    ...
    %pred_upsample   = smooth(round(spline(x, pred, xx)), 'sgolay', 3);
